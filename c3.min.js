    ...
    (l.prototype.beforeInit = function () {}),
        ...
        (l.prototype.initParams = function () {
            ...
            (t.clipId = "c3-" + +new Date() + "-clip"),
                ...
                (t.dataTimeParse = (i.data_xLocaltime
                    ? e.timeParse
                    : e.utcParse)(t.config.data_xFormat)),
                ...
                ? (i = new MutationObserver(function (t) {
                      t.forEach(function (t) {
                          "childList" === t.type &&
                              t.previousSibling &&
                              (i.disconnect(),
                              (n.intervalForObserveInserted = window.setInterval(
                                  function () {
                                      e.node().parentNode &&
        ...
        (l.prototype.getXDomainPadding = function (t) {
            ...
            return (
                ...
                "object" === s(a.axis_x_padding) && L(a.axis_x_padding)
                    ? ((n = C(a.axis_x_padding.left)
                          ? a.axis_x_padding.left
                          : i),
                      (r = C(a.axis_x_padding.right)
        ...
        (l.prototype.redrawEventRect = function () {
            ...
            function u(t, e) {
                return (
                    e &&
                    (s.isBarType(e.id) || s.dist(e, t) < d.point_sensitivity)
                );
            }
            function h(t) {
                                      ...
                                      if (!s.hasArcType(t)) {
                                          ...
                                          if (
                                              ...
                                              if (n) a = n;
                                                  ...
                                                  var o = d.axis_rotated
                                                      ? i[1]
                                                      : i[0];
                                                  a = s.findClosestFromTargetsByX(
                                                      t,
                                                      s.x.invert(o)
                                                  );
                                              }
